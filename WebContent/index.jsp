...
<body>
	...
	<div style="margin: 15px auto; " >
		<!-- 搜索表单 -->
		<s:form action="Topic_list" cssClass="simpleSearchForm" theme="simple">
		...
		<tbody class="list topicList">
	        ...
	        <s:iterator value="#list" var="topic">
	        	<tr class="data">
		            ...
		            <td><a href="showTopic.html"><s:property value="title"/></a></td>
	...
	<!--发表主题表单-->
	<s:form action="Topic_add" theme="simple">
